...
| Early Modern English | EEBO-TCP Phase I | Explicitly public domain | Use the **original-spelling** build, never standardized-spelling — standardizing destroys the form-evolution signal Strata exists to show. Large (4GB unzipped); needs a storage strategy, not a naive full ingest. |
